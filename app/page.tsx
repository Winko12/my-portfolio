...
export default function Home() {
  // This is our reusable animation setting!
  const fadeInUp = {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 font-sans selection:bg-blue-500 selection:text-white overflow-hidden">
      ...
      <main className="max-w-5xl mx-auto px-6">
        ...
        <section className="py-32 flex flex-col md:flex-row items-center justify-between gap-12 min-h-[80vh]">
          ...
          >
            {/* NEW: Available for Work Indicator */}
            <div className="flex items-center gap-3 px-4 py-2 bg-green-500/10 border border-green-500/20 rounded-full w-fit mb-6">
              ...
              <span className="text-sm text-green-400 font-medium tracking-wide">Available for work</span>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              <a href="/resume.pdf" download="Win_Ko_Oo_Resume.pdf" className="border border-white/20 text-white font-semibold py-3 px-8 rounded-full hover:bg-white/10 transition-all hover:border-white/40">
                Download CV
              </a>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {['TypeScript', 'JavaScript', 'Dart', 'Next.js', 'React', 'Tailwind CSS', 'Git', 'GitHub'].map((skill, index) => (
                  <motion.span
                    key={skill}
                    className="px-4 py-2 bg-white/5 border border-white/10 text-gray-300 rounded-full text-sm hover:bg-blue-500/20 hover:text-blue-400 hover:border-blue-500/50 transition-all cursor-default"
                    initial={{ opacity: 0, scale: 0.8 }}
      ...
      {/* 5. FOOTER */}
      <motion.footer id="contact" className="py-16 text-center border-t border-white/10 mt-10" {...fadeInUp}>
